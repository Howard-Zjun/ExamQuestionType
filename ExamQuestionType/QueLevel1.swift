...
extension QueLevel1 {
    ...
    static var wordPracticeModel: QueLevel1 {
        .init(name: "词汇专练", descri: "一、根据英文释义填写对应的单词。", queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: [
    ...
    static var listenModel: QueLevel1 {
        .init(name: "听力强化", descri: "一、听短对话，选择正确答案（共6小题；每小题1分，满分6分）", queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: "/resources/listening_exam/audio/4e/81/4e81f53cfca2a84c0a869e3812fc53b1.mp3", subLevel2: nil, content: "<p>What are the speakers talking about in general?</p>", correctAnswers: ["B"], options: ["An essay.", "Famous people.", "A tutor."], type: .Select, no: "1", isNormal: true),
            .init(videoUrl: nil, voiceUrl: "/resources/listening_exam_audio/c2/a5/5a/c2a55acc0d133a16cc32606b4e8fe481.mp3", subLevel2: nil, content: "<p>Which one is the right answer to the question?</p>", correctAnswers: ["A"], options: ["Du Fu.", "Li Bai.", "Li Shangyin."], type: .Select, no: "2", isNormal: true),
            .init(videoUrl: nil, voiceUrl: "/resources/listening_exam/audio/49/af/49afac3a03f3563a05739f4baacf1467.mp3", subLevel2: [
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>When did Alisha realize she wanted to be famous?</p>", correctAnswers: ["B"], options: ["When she was at secondary school.", "When a girl she knew joined in a TV show.", "When her classmate encouraged her to go on a TV show."], type: .Select, no: "1", isNormal: true),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>How did Alisha feel when she heard the result of the talent competition?</p>", correctAnswers: ["A"], options: ["Delighted.", "Disappointed.", "Annoyed."], type: .Select, no: "2", isNormal: true)
            ], content: nil, correctAnswers: nil, options: nil, type: .Record, no: nil, isNormal: false)
        ])
    }
    
    static var listenSpeakModel: QueLevel1 {
        .init(name: "听说训练", descri: "一、模仿朗读（满分3分）", queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>        Michael Jordan is a professional American basketball player. He is considered the best basketball player at all time. During the 1990s, he led the Chicago Bulls to six NBA championships, and earned the NBA\'s Most Valuable Player Award five times. Jordan went to university in 1981 and soon became an important member of the school\'s basketball team. In the summer of 1984, he participated in the Olympic Games in Los Angeles as a member of the U.S. team. They won the gold at the games that year. Then Jordan left college and joined the NBA. By the late 1980s, the Chicago Bulls were quickly becoming one of the best teams in the NBA, and Jordan\'s outstanding performance was making him the next big star of the game. With a shocking decision, Jordan retired from basketball in 1993 and started playing professional baseball. He returned to the Bulls in 1995 and finally ended his basketball career in 2003.</p>", correctAnswers: ["Michael Jordan is a professional American basketball player. He is considered the best basketball player at all time. During the 1990s, he led the Chicago Bulls to six NBA championships, and earned the NBA\'s Most Valuable Player Award five times. Jordan went to university in 1981 and soon became an important member of the school\'s basketball team. In the summer of 1984, he participated in the Olympic Games in Los Angeles as a member of the U.S. team. They won the gold at the games that year. Then Jordan left college and joined the NBA. By the late 1980s, the Chicago Bulls were quickly becoming one of the best teams in the NBA, and Jordan\'s outstanding performance was making him the next big star of the game. With a shocking decision, Jordan retired from basketball in 1993 and started playing professional baseball. He returned to the Bulls in 1995 and finally ended his basketball career in 2003."], options: nil, type: .Record, no: nil, isNormal: true)
        ])
    }
