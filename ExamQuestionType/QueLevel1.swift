...
extension QueLevel1 {
    ...
    static var closeModel: QueLevel1 {
        .init(name: "完形填空", descri: "阅读下面短文，从每题所给的A、B、C、D四个选项中选出可以填入空白处的最佳选项。", type: .cloze, queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: [
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["B"], options: ["equal", "unique", "passive", "eager"], type: .Select, no: 1),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["C"], options: ["contact", "theme", "difficulties", "comfort"], type: .Select, no: 2),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["D"], options: ["hang over", "take in", "show off", "smooth out"], type: .Select, no: 3),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["A"], options: ["add", "escape", "attract", "prove"], type: .Select, no: 4),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["D"], options: ["contribute", "attack", "concentrate", "share"], type: .Select, no: 5),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["A"], options: ["move", "advance", "focus", "exchange"], type: .Select, no: 6),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["C"], options: ["which", "that", "where", "when"], type: .Select, no: 7),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["B"], options: ["viewed", "guided", "argued", "suffered"], type: .Select, no: 8),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["A"], options: ["responsible", "original", "secure", "positive"], type: .Select, no: 9),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["B"], options: ["Serbia", "China", "Bosnia", "Italy"], type: .Select, no: 10),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["C"], options: ["stress", "potential", "opportunity", "strength"], type: .Select, no: 11),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["D"], options: ["at", "for", "to", "against"], type: .Select, no: 12),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["C"], options: ["design", "judge", "play", "explode"], type: .Select, no: 13),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["B"], options: ["leaving", "graduating", "volunteering", "struggling"], type: .Select, no: 14),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk mlen=\"3\" mstyle></blk></p>", correctAnswers: ["D"], options: ["response", "judge", "play", "challenges"], type: .Select, no: 15)
            ], content: "<p>        It is an honor for me to give this speech as one of the graduating students and welcome you to this special Graduating Ceremony 2020 in Tsinghua University.</p><p>        This is a （1）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>moment. We are stepping up to another period of our lives at a time of great hardship and global （2）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>. Tsinghua keeps in mind its global family, and hopes this ceremony will help （3）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>sad memories, refresh beautiful ones and （4）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>more wonderful memories into our lives.</p><p>        Each of us has different stories to share, of amazing life experiences and challenges. Please allow me to （5）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>with you the course of my journey which has made me what I am today.</p><p>        I was born in the middle of war, which caused my family to （6）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>Serbia for three years. When the war ended, we returned to Bosnia （7）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>I was unfortunately raised by a single parent. My mother, who is and will ever be my heroine, was the only figure who （8）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>me, supported me and kept me on the right way. I thanked her so much because only she is （9）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>for a huge part of my success. I will always remember her teachings, “to complain less and always find solutions at the price of whatever it takes”, which brought me to （10）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>, an ancient land of new hopes.</p><p>        During the COVID-19 outbreak, I got the best （11）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>to understand China. I saw millions of people united with one goal—to win the battle （12）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>this epidemic(流行病). Everyone has a role to （13）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>against the virus. In Tsinghua, I played a little but necessary role.</p><p>        Friends, we are now （14）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>from one of the world\'s best universities. Let us accept new （15）<blk mlen=\"3\"  mstyle=\"underline\" ></blk>, think beyond our limits and keep in mind the truth of life.</p>", correctAnswers: nil, options: nil, type: .FillBlank, no: nil)
        ])
    }
    ...
    static var wordPracticeModel: QueLevel1 {
        .init(name: "词汇专练", descri: "一、根据英文释义填写对应的单词。", type: .wordPractice, queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: [
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk  mlen=\"3\" mstyle=\"underline\"></blk> (adj.) extremely important, because it will affect other things</p>", correctAnswers: ["crucial"], options: nil, type: .FillBlank, no: 1),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk  mlen=\"3\" mstyle=\"underline\"></blk> (adj.) connected with education, especially studying in schools and universities</p>", correctAnswers: ["academic"], options: nil, type: .FillBlank, no: 2),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p><blk  mlen=\"3\" mstyle=\"underline\"></blk> (v.) to form an opinion of the amount, value or quality of sth after thinking about it carefully</p>", correctAnswers: ["evaluate"], options: nil, type: .FillBlank, no: 3)
            ], content: "<p>crucial       flow      academic      patent      conclusion</p><p>evaluate     politician   defeat         device     remarkable</p>", correctAnswers: nil, options: nil, type: .FillBlank, no: nil)
        ])
    }
    
    static var listenModel: QueLevel1 {
        .init(name: "听力强化", descri: "一、听短对话，选择正确答案（共6小题；每小题1分，满分6分）", type: .listen, queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: "/resources/listening_exam/audio/4e/81/4e81f53cfca2a84c0a869e3812fc53b1.mp3", subLevel2: nil, content: "<p>What are the speakers talking about in general?</p>", correctAnswers: ["B"], options: ["An essay.", "Famous people.", "A tutor."], type: .Select, no: 1),
            .init(videoUrl: nil, voiceUrl: "/resources/listening_exam_audio/c2/a5/5a/c2a55acc0d133a16cc32606b4e8fe481.mp3", subLevel2: nil, content: "<p>Which one is the right answer to the question?</p>", correctAnswers: ["A"], options: ["Du Fu.", "Li Bai.", "Li Shangyin."], type: .Select, no: 2),
            .init(videoUrl: nil, voiceUrl: "/resources/listening_exam/audio/49/af/49afac3a03f3563a05739f4baacf1467.mp3", subLevel2: [
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>When did Alisha realize she wanted to be famous?</p>", correctAnswers: ["B"], options: ["When she was at secondary school.", "When a girl she knew joined in a TV show.", "When her classmate encouraged her to go on a TV show."], type: .Select, no: 1),
                .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>How did Alisha feel when she heard the result of the talent competition?</p>", correctAnswers: ["A"], options: ["Delighted.", "Disappointed.", "Annoyed."], type: .Select, no: 2)
            ], content: nil, correctAnswers: nil, options: nil, type: .Comprehensive, no: nil)
        ])
    }
    
    static var listenSpeakModel: QueLevel1 {
        .init(name: "听说训练", descri: "一、模仿朗读（满分3分）", type: .speak, queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>        Michael Jordan is a professional American basketball player. He is considered the best basketball player at all time. During the 1990s, he led the Chicago Bulls to six NBA championships, and earned the NBA\'s Most Valuable Player Award five times. Jordan went to university in 1981 and soon became an important member of the school\'s basketball team. In the summer of 1984, he participated in the Olympic Games in Los Angeles as a member of the U.S. team. They won the gold at the games that year. Then Jordan left college and joined the NBA. By the late 1980s, the Chicago Bulls were quickly becoming one of the best teams in the NBA, and Jordan\'s outstanding performance was making him the next big star of the game. With a shocking decision, Jordan retired from basketball in 1993 and started playing professional baseball. He returned to the Bulls in 1995 and finally ended his basketball career in 2003.</p>", correctAnswers: "Michael Jordan is a professional American basketball player. He is considered the best basketball player at all time. During the 1990s, he led the Chicago Bulls to six NBA championships, and earned the NBA\'s Most Valuable Player Award five times. Jordan went to university in 1981 and soon became an important member of the school\'s basketball team. In the summer of 1984, he participated in the Olympic Games in Los Angeles as a member of the U.S. team. They won the gold at the games that year. Then Jordan left college and joined the NBA. By the late 1980s, the Chicago Bulls were quickly becoming one of the best teams in the NBA, and Jordan\'s outstanding performance was making him the next big star of the game. With a shocking decision, Jordan retired from basketball in 1993 and started playing professional baseball. He returned to the Bulls in 1995 and finally ended his basketball career in 2003.", options: nil, type: .Record, no: nil)
        ])
    }
    
    static var grammarPracticeModel: QueLevel1 {
        .init(name: "语法专练", descri: "请从A、B、C、D四个选项中选择正确的答案。", type: .grammarPractice, queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>Celeste Ng\'s latest book, ___ plot is quite new and original, has received a lot of attention.<blk mlen=\"3\"   ></blk></p>", correctAnswers: ["C"], options: ["which", "where", "whose", "that"], type: .Select, no: 1),
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>___ is known to everybody, the moon travels around the earth once every month.<blk     mlen=\"3\" mstyle></blk></p>", correctAnswers: ["C"], options: ["Which", "That", "As", "What"], type: .Select, no: 2),
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>I walk through the doors into the waiting area, ___ there\'s a familiar atmosphere of boredom and tension.<blk  mlen=\"3\" mstyle></blk></p>", correctAnswers: ["D"], options: ["which", "that", "whose", "where"], type: .Select, no: 3)
        ])
    }
    
    static var essayModel: QueLevel1 {
        .init(name: "一、请根据下面的提示写 一封通知书。", descri: nil, type: .essayFillBlank, queLevel2Arr: [
            .init(videoUrl: nil, voiceUrl: nil, subLevel2: nil, content: "<p>请你以你校学生会的名义写一则关于成立英语阅读俱乐部（English book club）的英语通知，内容包括：</p><p>1.阅读在生活中的重要性；</p><p>2.成立英语阅读俱乐部的目的；</p><p>3.欢迎报名参加及提供建议。</p><p>注意：</p><p>1.词数100左右；</p><p>2.可以适当增加细节，以使行文连贯；</p><p><blk mlen=\"3\"  mstyle=\"underline\" ></blk></p>", correctAnswers: nil, options: nil, type: .FillBlank, no: nil)
        ])
    }
}
